...
export const siteConfig = {
  ...
  defaultTitle: "Bhakti Enterprises | Mobile & Electronics Shop in Solapur",
  defaultDescription:
    "Bhakti Enterprises is a trusted mobile and electronics shop in Solapur offering smartphones, accessories, and home appliances with clear guidance and practical pricing.",
  defaultKeywords: [
    "Bhakti Enterprises",
